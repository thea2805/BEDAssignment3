...
namespace IdentityTest.Data.Migrations
{
    ...
    [Migration("20220421110757_InitialSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment3.Models.Booking", b =>
                {
            ...
            modelBuilder.Entity("Assignment3.Models.Guest", b =>
                {
            ...
            modelBuilder.Entity("Assignment3.Models.Restaurant", b =>
                {
                    b.Property<int>("RestaurantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assignment3.Models.Room", b =>
                {
                    b.Property<int>("RoomId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assignment3.Models.Booking", b =>
                {
                    b.HasOne("Assignment3.Models.Employee", "Employee")
                        .WithMany("Booking")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Assignment3.Models.Restaurant", "Restaurant")
            ...
            modelBuilder.Entity("Assignment3.Models.Guest", b =>
                {
                    b.HasOne("Assignment3.Models.Room", "Room")
            ...
            modelBuilder.Entity("Assignment3.Models.Room", b =>
                {
                    b.HasOne("Assignment3.Models.Booking", "Booking")
